                ...
                <CardHeader className="flex flex-col md:flex-row items-start md:justify-between bg-muted/50 gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="grid gap-0.5">
                            ...
                            <CardDescription>SP ID: {data.tid}</CardDescription>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                        <div className="grid gap-3">
                            ...
                            <div className="grid gap-0.5 not-italic text-muted-foreground">
                                ...
                                <span>Bank Name: {data.bank_name}</span>
                                <span>Branch: {data.branch_name}</span>
                            </div>
                        </div>
                        <div className="grid auto-rows-max gap-3">
                            <div className="font-semibold">Mobile Banking</div>
                            <div className="grid gap-0.5 not-italic text-muted-foreground">
                                <span>bkash: {data.bkash_no}</span>
                                <span>Nagad: {data.nagad_no}</span>
                                <span>Rocket: {data.rocket_no}</span>
                            </div>
                        </div>
                    </div>
                </CardContent>
